...
Com os arquivos extraidos, foi possivel dar inicio ao processo de tratamento dos dados, que incluiu a concatenacao das bases anualmente, renomeacao de colunas, mapeamento de dados para tornar mais facil a leitura e criterios de inclusao da analise, alem de uma analise exploratoria dos dados. 
